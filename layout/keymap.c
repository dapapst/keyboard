...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_ESCAPE,      TD(DANCE_1),    LSFT(KC_TAB),   KC_DELETE,      KC_TAB,         KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_PGUP,        KC_HOME,        KC_UP,          KC_END,         KC_BSPACE,      KC_TRANSPARENT,
    KC_TRANSPARENT, KC_LCTRL,       KC_LALT,        KC_LSHIFT,      KC_ENTER,       KC_SPACE,       KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_PGDOWN,      KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_DELETE,      KC_TRANSPARENT,
  ...
  [2] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, TD(DANCE_2),    KC_EQUAL,       TD(DANCE_3),    KC_ASTR,        KC_PLUS,                                        KC_GRAVE,       KC_LCBR,        KC_RCBR,        KC_COLN,        KC_SCOLON,      KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_moonlander(
...
//     printf("ctrl %d shift %d alt %d\n", MOD_BIT(KC_LCTL), MOD_BIT(KC_LSHIFT), MOD_BIT(KC_LALT));
