...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LCTRL,       KC_LSHIFT,      KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, TD(DANCE_0),    KC_LALT,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
